...
![Fail2Ban service status](screenshots/fail2ban-service-status.png)
...
- **banaction = ufw**: Fail2Ban uses UFW to block attackers — this is the link between this dynamic, behavior-based layer and the static allow/deny rules in `ufw-firewall-hardening.md`  
- **sshd jail**: Protects SSH from brute‑force attacks  

Save and exit.

![Fail2Ban jail configuration](screenshots/fail2ban-jail-config.png)
...
![Fail2Ban detected and banned attacker IP](screenshots/fail2ban-attack-detected.png)
